...
@section('title')
    Poricharika.com | Office Assistant
@endsection
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8 col-sm-7">
                    <div class="top-text">
                        <p>{{ __('Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto ad dolores ipsa,praesentium temporibus at alias eligendi animi ducimus odio? Dolores, eum voluptatem hic eligendi est enim. Maxime, rerum eaque?Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto ad dolores ipsa,praesentium temporibus at alias eligendi animi ducimus odio? enim. Maxime, rerum eaque?') }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="single-price">
                            ...
                            <div class="btn-div">
                                <a href="{{ route('officeassistantform', app()->getLocale()) }}">
                                    <div class="book-btn">
                                        <p>{{ __('Book Now !') }}</p>
                                    </div>
                                </a>
