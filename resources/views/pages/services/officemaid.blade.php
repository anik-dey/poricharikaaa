        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-9 col-md-8 col-sm-7">
                    <div class="top-text">
                        <p>{{ __("Every office is crowded with people every day. So, it is very important to keep a office neat and tidy. From cleaning to serving tea to the employees and guests, a helping hand is needed to manage these works. Now a days, many offices are arranging lunch to their employees in the office. Keeping this growing need in mind, PORICHARIKA has brought this service where you will get experienced associates based only on your needs.") }}</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="single-price">
                            ...
                            <div class="btn-div">
                                <a href="{{ route('officemaidform', app()->getLocale()) }}">
                                    <div class="book-btn">
                                        <p>{{ __('Book Now !') }}</p>
                                    </div>
                                </a>
